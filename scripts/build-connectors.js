...
const DB = /BigQuery|Snowflake|PostgreSQL|MySQL|SQLServer|Oracle|Teradata|AlloyDB|Db2|Elasticsearch|Sybase|Hive|Spanner|Cloud SQL|Synapse|Athena|Redshift|BigQuery API|HANA|Teradata|Weaviate|Milvus|Qdrant|Vespa/i;
const FILE = /S3|Storage|Blob|Dropbox|Box|WebDAV|Sharepoint|Drive|WebDAV|WebDAV|FTP|WebDAV|Delta Lake|Data Lake/i;
